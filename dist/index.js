...
define("secure/config", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("secure/config.update", ["require", "exports", "ts-morph", "path", "stringify-object"], function (require, exports, ts_morph_1, path, stringify_object_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ConfigUpdate = void 0;
    path = __importStar(path);
    stringify_object_1 = __importDefault(stringify_object_1);
...
define("secure/index", ["require", "exports", "secure/config", "secure/config.update", "unzip-stream", "yawn-yaml/cjs", "fs-extra", "request", "path", "lodash"], function (require, exports, config_1, config_update_1, unzip, cjs_1, fse, request_1, path, _) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ServerlessSecure = void 0;
    unzip = __importStar(unzip);
    cjs_1 = __importDefault(cjs_1);
...
define("index", ["require", "exports", "secure/index"], function (require, exports, secure_1) {
    "use strict";
    return secure_1.ServerlessSecure;
});
