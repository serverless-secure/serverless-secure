...
export const slsCommands = {
  secure: {
    ...
    options: {
      path: {
        usage:
          'Specify which function you wish to secure: --path <Function Name> or -p <*>',
        required: false,
        shortcut: 'p',
      },
    }
  ...
  ['secure-session']: {
    ...
    options: {
      path: {
        usage:
          'Specify your session function: --path <Function Name> or -p <*>',
        required: false,
        shortcut: 'p',
      },
    }
  ...
  encrypt: {
    ...
    options: {
      path: {
        usage:
          'Specify what function you wish to encrypt: --path <Function Name> or -p <*>',
        required: false,
        shortcut: 'p',
      },
    }
  ...
  monitor: {
    ...
    options: {
      path: {
        usage:
          'Specify what function you wish to monitor: --path <Function Name> or -p <*>',
        required: false,
        shortcut: 'p',
      },
    }
